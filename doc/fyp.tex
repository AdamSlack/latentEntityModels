...
\begin{figure}[h]
  ...
  \end{subfigure}
  \caption{(Left) Bipartite graph showing strength of conceptual similarity between topics in two models. (Middle, Right) Document relationships formed by LSA and LDA topic modelling methods ~\cite{Crossno2011-sn}  \label{fig:topic_modelling_comparisons}}
\end{figure}
...
Perplexity is a commonly used metric accross topic modelling literature, and is an estimate of how well a model reduces a document. 

\section{Entitiy Modeling}
Entity Modelling exists as a field of study aside from topic modelling. However this study is considering the use of topic models as a means of describing and relating entities within a corpus.
