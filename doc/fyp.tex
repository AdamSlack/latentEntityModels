...
Notably, there is only significant variance in 3 out of the ten topics accross the novels.
...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.6]{hp_etms}
  \caption{ETM Pairwise Scatter Matrix for Entities in the Harry Potter Novel.\label{fig:hp_etm}}
\end{figure}


\begin{figure}[h!]
  \includegraphics[scale=0.14]{etm_closeup}
  \caption{ETM Pairwise Expanded View. \label{fig:etm_closeup}}
\end{figure}
