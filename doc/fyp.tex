...
When producing models using corpora consisting of books from the same series by the same author, it is frequent that there are re-occurring characters present throughout the documents.
