...
Whilst visually promising, there is still further investigation required in order to evaluate the quality of the Latent Entity Modelling method.
...
\begin{figure}[h!]
  \centering
\includegraphics[scale=0.15]{hp_summ_le_large}
\caption{Magnified View of Pairwise Scatter Plot Matrix for Entity Topic Models Coloured According to their Latent Entity Classification\label{hp_summ_le_large}}
\end{figure}

Really this is too sparse to see. (Should be clearer on paper...)
