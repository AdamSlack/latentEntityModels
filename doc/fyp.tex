...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.35]{phil_stone_getm}
  \caption{Gaussian Entity Term Matrix for the full document of Harry Potter and the Philosopher's Stone\label{fig:hp_full_ps_getm}} 
\end{figure}
...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.8]{phil_stone_significant_getm}
...
\begin{figure}[h!]
  \centering
\includegraphics[scale=1.0]{harry_quirrel_compare}
...
\begin{figure}[h!]
  \centering
  \includegraphics[angle=-90, scale=0.8]{hp_full_etms}
  \caption{ETM Pairwise Scatter Matrix for Entities in the Harry Potter Novels.\label{fig:hp_etm}}
\end{figure}
\clearpage

A pairwise matrix scatter plot of entity topic model topic proportions can show some insight into the variance and distributions of topics across corpus of entities. Figure~\ref{fig:hp_etm} confirms the significance of topics 1, 3, and 7 with regards to differentiating between entity topic models. Topics 0, 2, and 4, in this figure show a small but distinct separate grouping if entities that score highly in the topics where few others do. 
