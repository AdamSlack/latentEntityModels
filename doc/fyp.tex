...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.5]{architecture_diagram}
...
\subsection{Database}
The Database design was to be oriented around two key concepts: Book Entities, and Topics. Structuring the DB around these concepts allows for some reflective structure between the way that data is stored, and the way that users can access it through the API. 
\begin{figure}[h!]
  \centering
