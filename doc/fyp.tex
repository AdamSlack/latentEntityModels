...
{\hspace*{15mm} \(a)\, Choose\, a\, topic\, z_n \sim Multinomial(\theta_m)  \)}\\
{\hspace*{15mm} \(b)\, Choose\, a\, word\, w_n \sim Multinomial(\phi_m) \)}\\
...
Perplexity can be calculated by subsampling a corpus into training and testing sets.
