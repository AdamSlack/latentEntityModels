...
\begin{table}
  ...
  \end{tabular}
  \caption{Top Ten Words in the Topic-Word Distributionsof Calculated Topics for the Harry Potter Corpus.\label{}}
\end{table}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.15]{book_topics_large}
  \caption{Book Topic Distributions for a Large Corpus of Fiction and Non-Fiction Books \label{fig:book_topics_large}}
\end{figure}
...
\begin{appendices}
  ...
  \chapter{Gaussian Entity Term Matrix.}
  The follwoing pages show listings of the most strongly associated terms in the GETM for entities common to both corpora used within results and analysis.

  \chapter{Entity Topic Models.}
  The following pages show listings of the topic distributions for Entities common to both copora used within results and analysis.

  
  \chapter{Latent Entitity Models.}
  The following pages show listings of the Entities forming each Latent Entity within the corpora used within results and analysis.
