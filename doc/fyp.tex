...
The interface for the exploring Latent Entities was designed from a personal perspective, used to support the development of other aspects of the system. Implemented using TypeScript and the Angular 5 web framework, the application allows for system to be designed in terms of components, which translate effectively to the stages seen during the development of the analysis pipeline.
