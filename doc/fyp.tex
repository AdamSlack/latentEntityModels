...
Development begins with the implementation of a NLP toolkit as well as a Web-Server architecture capable of fascilitating the investigation going forward. Initial toolkit methods orient themselves around the task of proccesing a corpus of narratives into a computationally convenient format. The Web-Server architecture 
